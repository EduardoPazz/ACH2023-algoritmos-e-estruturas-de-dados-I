...
/* encontrarMinMax - copia a menor e a maior chave dentro do DEQUE para os
   enderecos min e max passados como parametro e retorna true. Se o DEQUE
   estiver vazio, deve retornar false. */

...
/* Destrui��o da fila (reinicializar)
...
bool inserirNaFila(FILA* f,REGISTRO reg) {
  ...
  novo->prox = f->cabeca->prox; // Caso ele seja o primeiro elemento a ser inserido, receberá como `prox` o valor NULL, o que é esperado
  f->cabeca->prox = novo;
  
  if (!(f->fim)) f->fim = novo; // Caso ele seja o primeiro elemento a ser inserido, ele estará no fim da fila também
